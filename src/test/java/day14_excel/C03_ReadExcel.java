...
public class C03_ReadExcel {
    ...
    public void readExcelTesti() throws IOException {
        ...
        // input olarak verilen satirNo, sutunNo degerlerini parametre olarak
        // satirNo, sutunNo degerlerini parametre olarak alip
        // o cell"deki datayi String olarak donduren bir method olusturun

        int satirNo = 4;
        int sutunNo = 4;

        //donen String in Cezayir in oldugunu test edin
